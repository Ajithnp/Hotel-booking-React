    ...
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
       <div>
         <div className='flex flex-col items-start text-left'>
            ...
            Take adavatanges of our limited-time offers and specual packages to enhance your stay and create unforgettable memories
            </p>
          </div>
          ...
          <div className='text-xs cursor-pointer'>
            <span onClick={()=> setopenFilters(!openFilters)}
             className='lg:hidden'>
              ...
              {openFilters ? 'HIDE' : 'SHOW'}</span> {/*only visible in small screen */}
